...
class EMA:
    ...
    def __init__(self, stock_obj, *args, **kwargs):
        ...
        self.histogram_min  = self.ema_config.get('histgoram_min', -3)
        self.histogram_max  = self.ema_config.get('histgoram_max', 3)
        self.buy_count_max  = self.ema_config.get('buy_count_max', 3)
        self.sell_count_max = self.ema_config.get('sell_count_max', 3)
